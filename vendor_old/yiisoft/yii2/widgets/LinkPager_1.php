...
class LinkPager extends Widget
{
     ...
     */
    public $firstPageLabel = true; //false;
    /**
     * @var string|boolean the text label for the "last" page button. Note that this will NOT be HTML-encoded.
     * If it's specified as true, page number will be used as label.
     * Default is false that means the "last" page button will not be displayed.
     */
    public $lastPageLabel = true; //false;
    public $firstButtonLabel = '&laquo;';
    public $lastButtonLabel = '&raquo;';
    /**
    ...
    protected function renderPageButtons()
    {
        ...
        if ($firstPageLabel !== false) {
            ...
            $buttons[] = $this->renderPageButton($this->firstButtonLabel, 0, $this->firstPageCssClass, $currentPage <= 0, false);
        }
        ...
        if ($lastPageLabel !== false) {
            ...
            $buttons[] = $this->renderPageButton($this->lastButtonLabel, $pageCount - 1, $this->lastPageCssClass, $currentPage >= $pageCount - 1, false);
        }
        
        /*==================custom penambahan jump to =======================*/
        $buttons[] = $this->renderCustomPage();
        $buttons[] = $this->renderPageSize();
        /*===================================================================*/
    ...
    /*======================= custom penambahan jump ============================*/
        protected function renderCustomPage(){
            ...
            return "&nbsp; Jump to ".$this->customPageBefore.Html::textInput($this->pagination->pageParam, $page,$this->customPageOptions).$this->customPageAfter;
        }
        ...
        protected function renderPageSize(){
            ...
            return " Page Size ".Html::dropDownList($this->pagination->pageSizeParam, $this->pagination->getPageSize(), $pageSizeList, $this->pageSizeOptions);
            */
            
            return " Page Size ".Html::textInput($this->pagination->pageSizeParam, $this->pagination->getPageSize(), $this->customPageOptions);
        }
    /*===========================================================================*/
}
