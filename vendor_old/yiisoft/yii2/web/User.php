...
class User extends Component
{
    ...
    public function login(IdentityInterface $identity, $duration = 0)
    {
        ...
        if ($this->beforeLogin($identity, false, $duration)) {
            ...
            Yii::$app->getRequest()->activityLogin();
     ...
     * @see getIdentity()
     */
    public function getFlagLogin()
    {
        $identity = $this->getIdentity();

        return $identity !== null ? $identity->flag_login : null;
    }
    ...
    //============================================================== Custome User ======================================================
     ...
     /**
     * Mengembalikan accepted ip user
     * 
     */
    
    public function getAcceptedIP(){
        return $this->_identity->accepted_ip;
    }
    ...
    public function getRTriesCount(){
        return $this->_identity->rtries_count;
    }
    ...
    public function getUsermode(){
        return strtolower($this->_identity->usermode);
    }

    /**
     * Mengembalikan IP user sekarang
     * @return ip
     * 
     */
    ...
    /**
     * Mengembalikan field Change Password Date
     * @return ip
     * 
     */
    public function getChangePassDate()
    {
        return $this->_identity->change_pass_date;
    }

    public function getLastAction(){
        return $this->_identity->last_action;   
    }
