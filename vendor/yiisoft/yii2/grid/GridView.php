...
class GridView extends BaseListView
{
    ...
    public function run()
    {
        // echo "diana fitri<pre>";print_r($this->getView());echo "</pre>";
    ...
    public function renderItems()
    {
        ...
        // echo "masuk gan<pre>";print_r($this->renderTableHeader());echo "</pre>";
    ...
    public function renderTableHeader()
    {
        ...
        $cells = [];
        // echo "columns<pre>";print_r($this->columns);echo "</pre>";die();
        foreach ($this->columns as $column) {
            /* @var $column Column */
