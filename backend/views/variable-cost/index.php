...
/* @var $searchModel backend\models\VariableCostSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Variable Costs';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="variable-cost-index">
    <p>
        <?=
    ...
    <?php Pjax::begin(['id'=>'variable-cost-grid','enablePushState'=>false]);?>
    <?= GridView::widget([
...
$js = <<<JS
    ...
    $('form#{$searchModel->formName()}').on('beforeSubmit',function(e){
        ...
        var \$form = $(this);
        $.pjax.reload({url:\$form.attr('action')+'&per-page='+$("input[name='per-page']").val()+'&'+\$form.serialize(),container:"#variable-cost-grid",async:false,replace:false});                 
        return false;
    });
