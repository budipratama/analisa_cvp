...
<div class="products-index">
    ...
    <?php Pjax::begin(['id'=>'products-grid','enablePushState'=>false]);?>
    <?= GridView::widget([
...
$js = <<<JS
    ...
    $('form#{$searchModel->formName()}').on('beforeSubmit',function(e){
        ...
        var \$form = $(this);
        $.pjax.reload({url:\$form.attr('action')+'&per-page='+$("input[name='per-page']").val()+'&'+\$form.serialize(),container:"#products-grid",async:false,replace:false});                 
        return false;
    });
